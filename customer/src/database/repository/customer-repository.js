...
class CustomerRepository {
  ...
  async AddWishlistItem(customerId, { _id,name,desc,price,available,img}) {

    const product = { _id,name,desc,price,available,img };
  ...
  async AddCartItem(customerId, { _id,name,price,img }, qty, isRemove) {
    try {
